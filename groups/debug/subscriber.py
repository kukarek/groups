...
import sql
from config import RULES_LINK, PAYMENT, EXAMPLE_WORDS
...
def editing_status_handler(user_id, message_text, group_id):
    ...
    if message_text == "/start" or message_text == "Главное меню":
        ...
        return EXAMPLE_WORDS, create_applicant_keyboard(keywords=sql.get_keywords(user_id=user_id, group_id=group_id)), None
